    ...
    <div class="space-y-12">
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
         ...
         <x-form-label for="first_name">First Name</x-form-label>
            ...
            <div class="mt-2">
             <x-form-input name="first_name" id="first_name"  placeholder="" required />
            ...
            <div class="sm:col-span-4">
                <x-form-field>
                    <x-form-label for="last_name">Last Name</x-form-label>
                       ...
                       <div class="mt-2">
                        <x-form-input name="last_name" id="last_name"  placeholder="" required />
            ...
            <div class="sm:col-span-4">
                <x-form-field>
                    <x-form-label for="email">Email Address</x-form-label>
                       ...
                       <div class="mt-2">
                        <x-form-input name="email" id="email" type="email" placeholder="" required />
